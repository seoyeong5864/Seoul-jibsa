    ...
    <>
      ...
      <div className="bg-white w-full rounded-3xl p-6 flex flex-col items-center text-center shadow-[0_10px_40px_rgba(0,0,0,0.05)] relative overflow-hidden">
        ...
        <div className="mb-2 relative flex items-center justify-center w-15 h-15">
          {/* Circle */}
          <div className="relative w-14 h-14 bg-red-100 rounded-full flex items-center justify-center">
        ...
        {/* Title */}
        <h4 className="text-lg font-bold text-red-500 mb-8">
          아쉽네요, 오답입니다.
        </h4>

        {/* Answer Comparison (Side by Side) */}
        <div className="flex w-full justify-center gap-4 md:gap-8 mb-10">
          {/* User's Answer */}
